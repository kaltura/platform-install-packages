...
Source0: gpac-0.5.0.tar.gz
%{?_with_amr:Source1:http://www.3gpp.org/ftp/Specs/archive/26_series/26.073/26073-700.zip}
...
%{!?_without_jack:Requires: jack-audio-connection-kit}
