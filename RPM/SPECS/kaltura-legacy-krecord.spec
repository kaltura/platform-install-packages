...
Name:	kaltura-legacy-%{widget_name}
Version: v1 
Epoch: 1
Release: 1
...
# for i in %{legacy_krecord_vers};do
mv %{_builddir}/%{name}/* $RPM_BUILD_ROOT/%{prefix}/web/flash/%{widget_name}/
find $RPM_BUILD_ROOT/%{prefix}/web/flash/%{widget_name} -name ".project" -exec rm {} \;
# done

%clean
rm -rf %{buildroot}
rm -rf %{_builddir}/%{widget_name}
# rm -rf %{_builddir}/%{version}
...
%changelog
* Tue Jan 26 2016 Kobi Michaeli <kobi.michali@kaltura.com> - v1
- Ported kaltura-krecord to be used for kaltura-legacy-krecord
