...
Name: kaltura-nginx
Version: 1.8.0
Release: 4%{?nginx_vod_module_ver:.}%{nginx_vod_module_ver}
Vendor: Kaltura inc.
URL: http://nginx.org/
...
%changelog
* Tue Feb 9 2016 Igot Shevach <igor.shevach@kaltura.com> - 1.8.0-4
- append release with vod-packager version.
