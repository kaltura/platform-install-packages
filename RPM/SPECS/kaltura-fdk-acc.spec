...
cat > $RPM_BUILD_ROOT%{_sysconfdir}/ld.so.conf.d/kaltura_fdk-acc.conf << EOF
%{prefix}/lib
EOF
...
%config %{_sysconfdir}/ld.so.conf.d/kaltura_fdk-acc.conf
