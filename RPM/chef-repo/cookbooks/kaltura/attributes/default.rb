...
default[:kaltura][:CDN_HOST] = "amfront.kaltura.dev"
default[:kaltura][:RED5_HOST] = "amfront.kaltura.dev"
default[:kaltura][:KALTURA_VIRTUAL_HOST_NAME] = "amfront.kaltura.dev"
...
default[:kaltura][:SPHINX_SERVER1] = "amnfs"
default[:kaltura][:SPHINX_SERVER2] = "amnfs"
default[:kaltura][:DB1_PORT] = "3306"
default[:kaltura][:DB1_HOST] = "amnfs" 
...
default[:kaltura][:DWH_HOST] = "amnfs"
default[:kaltura][:DWH_USER] = "etl"
default[:kaltura][:DWH_PASS] = "somepasswd1"
default[:kaltura][:SPHINX_DB_HOST] = "amnfs"
