...
"
	...
	grep -rl p_20130831 $BASE_DIR/dwh/ddl/ | xargs sed -i "s/p_20130831/p_$LDAYLASTMONTH/g"
	grep -rl p_201308 $BASE_DIR/dwh/ddl/ | xargs sed -i "s/p_201308/p_$LASTMONTH/g"
	grep -rl 20130901 $BASE_DIR/dwh/ddl/ | xargs sed -i "s/20130901/$FDAYCURMONTH/g"
	grep -rl 20130902 $BASE_DIR/dwh/ddl/ | xargs sed -i "s/20130902/$SDAYCURMONTH/g"
	grep -rl p_20131231 $BASE_DIR/dwh/ddl/ | xargs sed -i "s/p_20131231/p_$LDAYLASTMONTH/g"
	grep -rl p_201312 $BASE_DIR/dwh/ddl/ | xargs sed -i "s/p_201312/p_$LASTMONTH/g"
	grep -rl 20140101 $BASE_DIR/dwh/ddl/ | xargs sed -i "s/20140101/$FDAYCURMONTH/g"
	grep -rl p_201406 $BASE_DIR/dwh/ddl/ | xargs sed -i "s/p_201406/p_$LASTMONTH/g"
	grep -rl 20140701 $BASE_DIR/dwh/ddl/ | xargs sed -i "s/20140701/$FDAYCURMONTH/g"
	grep -rl p_201510 $BASE_DIR/dwh/ddl/ | xargs sed -i "s/p_201510/p_$LASTMONTH/g"
	grep -rl 20151101 $BASE_DIR/dwh/ddl/ | xargs sed -i "s/20151101/$FDAYCURMONTH/g"
