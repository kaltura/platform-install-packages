...
"
	...
	grep -rl p_20131231 $BASE_DIR/dwh/ddl/ | xargs sed -i "s/p_20131231/p_$(date '+%Y%m%d' -d "-$(date +%d) days")/g"
	grep -rl p_201312 $BASE_DIR/dwh/ddl/ | xargs sed -i "s/p_201312/p_$(date '+%Y%m' -d "-$(date +%d) days")/g"
	grep -rl 20140101 $BASE_DIR/dwh/ddl/ | xargs sed -i "s/20140101/$(date '+%Y%m%d' -d "-$(($(date +%d)-1)) days")/g"
	grep -rl p_201406 $BASE_DIR/dwh/ddl/ | xargs sed -i "s/p_201406/p_$(date '+%Y%m' -d "-$(date +%d) days")/g"
	grep -rl 20140701 $BASE_DIR/dwh/ddl/ | xargs sed -i "s/20140701/$(date '+%Y%m%d' -d "-$(($(date +%d)-1)) days")/g"
	grep -rl p_201510 $BASE_DIR/dwh/ddl/ | xargs sed -i "s/p_201510/p_$(date '+%Y%m' -d "-$(date +%d) days")/g"
	grep -rl 20151101 $BASE_DIR/dwh/ddl/ | xargs sed -i "s/20151101/$(date '+%Y%m%d' -d "-$(($(date +%d)-1)) days")/g"
