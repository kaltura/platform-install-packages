...
PARTNER_MONITORING_PROXY_ADMIN_SECRET=`< /dev/urandom tr -dc "A-Za-z0-9_~@$%^*()_+-=" | head -c100`
HASHED_PARTNER_MONITORING_PROXY_ADMIN_SECRET=`echo $PARTNER_MONITORING_PROXY_ADMIN_SECRET|md5sum`
PARTNER_MONITORING_PROXY_ADMIN_SECRET=`echo $HASHED_PARTNER_MONITORING_PROXY_ADMIN_SECRET|awk -F " " '{print $1}'`

PARTNER_MONITORING_PROXY_SECRET=`< /dev/urandom tr -dc "A-Za-z0-9_~@$%^*()_+-=" | head -c100`
HASHED_PARTNER_MONITORING_PROXY_SECRET=`echo $PARTNER_MONITORING_PROXY_SECRET|md5sum`
PARTNER_MONITORING_PROXY_SECRET=`echo $HASHED_PARTNER_MONITORING_PROXY_SECRET|awk -F " " '{print $1}'`

PARTNER_KMC_SSO_ADMIN_SECRET=`< /dev/urandom tr -dc "A-Za-z0-9_~@$%^*()_+-=" | head -c100`
HASHED_PARTNER_KMC_SSO_ADMIN_SECRET=`echo $PARTNER_KMC_SSO_ADMIN_SECRET|md5sum`
PARTNER_KMC_SSO_ADMIN_SECRET=`echo $HASHED_PARTNER_KMC_SSO_ADMIN_SECRET|awk -F " " '{print $1}'`

PARTNER_KMC_SSO_SECRET=`< /dev/urandom tr -dc "A-Za-z0-9_~@$%^*()_+-=" | head -c100`
HASHED_PARTNER_KMC_SSO_SECRET=`echo $PARTNER_KMC_SSO_SECRET|md5sum`
PARTNER_KMC_SSO_SECRET=`echo $HASHED_PARTNER_KMC_SSO_SECRET|awk -F " " '{print $1}'`
