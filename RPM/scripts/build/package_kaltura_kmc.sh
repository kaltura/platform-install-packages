...
wget $KMC_LOGIN_URI -O $KMC_RPM_NAME-$KMC_LOGIN_VERSION.tar.gz 
tar zxf $KMC_RPM_NAME-$KMC_LOGIN_VERSION.tar.gz
mkdir -p $SOURCE_PACKAGING_DIR/$KMC_RPM_NAME-$KMC_VERSION/login
mv kmc-login-$KMC_LOGIN_MINUS_V_VERSION $SOURCE_PACKAGING_DIR/$KMC_RPM_NAME-$KMC_VERSION/login/$KMC_LOGIN_VERSION
