...
for SOURCE in HTML5LIB3 PLAYKIT_IMA PLAYKIT_YOUBORA PLAYKIT_GOOGLE_ANALYTICS PLAYKIT_GOOGLE_TAG_MANAGER PLAYKIT_OFFLINE_MANAGER PLAYKIT_CAST_SENDER PLAYKIT_CAST_RECEIVER PLAYKIT_VR PLAYKIT_FLASH PLAYKIT_YOUTUBE PLAYKIT_BUMPER PLAYKIT_KAVA PLAYKIT_KALTURA_LIVE PLAYKIT_QNA PLAYKIT_NAVIGATION PLAYKIT_HOTSPOTS PLAYKIT_TRANSCRIPT PLAYKIT_DUAL_SCREEN PLAYKIT_TIMELINE PLAYKIT_CUEPOINTS PLAYKIT_INFO PLAYKIT_PLAYLIST PLAYKIT_AIRPLAY PLAYKIT_MODERATION PLAYKIT_RELATED PLAYKIT_IVQ PLAYKIT_SHARE;do
	URI=${SOURCE}_URI
