...
for SOURCE in HTML5LIB3 PLAYKIT_IMA PLAYKIT_YOUBORA PLAYKIT_GOOGLE_ANALYTICS PLAYKIT_OFFLINE_MANAGER PLAYKIT_CAST_SENDER PLAYKIT_CAST_RECEIVER PLAYKIT_VR PLAYKIT_FLASH;do
	URI=${SOURCE}_URI
