...
Note that supported 
While already supported by the code, this document doesn't yet provide cluster instructions. Cluster deployment by specific server-roles/groups will soon be added.
