...
1. Use the default self signed certs generated by httpd_ssl:
...
1. Alternatively, it is recommended that you use a properly signed certificate and use it instead of self-signed certificates. You can generate a free valid cert using http://cert.startcom.org/.    
